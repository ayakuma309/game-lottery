            ...
            <div className="mx-8 md:mx-20 pt-10 text-white mt-24">
                <article className="prose prose-sm max-w-none">
                    <p>
                        ...
                        （以下、「当方」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
                    </p>
                </article>
                ...
                <article className="prose prose-sm">
                    ...
                    <h3 className="font-bold">第2条（利用登録）</h3>
                    <ol>
                        <li>
                    ...
                    <h3 className="font-bold">第4条（禁止事項）</h3>
                    <p>
                    ...
                    <h3 className="font-bold">第8条（サービス内容の変更等）</h3>
                    <p>
                        当方は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。
                    </p>
                    <h3 className="font-bold">第9条（利用規約の変更）</h3>
                    <ol>
                        <li>
                    ...
                    <h3 className="font-bold">第10条（個人情報の取扱い）</h3>
                    <p>
                        当方は，本サービスの利用によって取得する個人情報については，当方「プライバシーポリシー」に従い適切に取り扱うものとします。
                    </p>
                    <h3 className="font-bold">第11条（通知または連絡）</h3>
                    <p>
                    ...
                    <h3 className="font-bold">第13条（準拠法・裁判管轄）</h3>
                    <ol>
                        <li>
